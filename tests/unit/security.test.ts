...
describe('Worker-compatible credential and idle security', () => {
  ...
  it('compares bootstrap secrets safely and sets exactly a sixty-second idle expiry', async () => {
    ...
    expect(idleExpiry(new Date('2026-08-28T10:00:00.000Z'))).toBe('2026-08-28T10:01:00.000Z');
  });
});
